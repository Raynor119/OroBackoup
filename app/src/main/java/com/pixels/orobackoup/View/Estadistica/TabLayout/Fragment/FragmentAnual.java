...
import com.pixels.orobackoup.View.Estadistica.TabLayout.Calendario.AnnoPickerDialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Bcalendario.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AnnoPickerDialog pd = new AnnoPickerDialog(FragmentAnual.this,anno);
                pd.SelectFecha();
            }
        });
